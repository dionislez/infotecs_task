...
async def get_city_by_geonameid(
    ...
    '''http://127.0.0.1:8000/cities/{geonameid}'''
    try:
        int(geonameid)
    except ValueError:
...
async def get_cities_by_page_and_count(
    ...
    '''http://127.0.0.1:8000/cities?page={page}&count={count}'''
...
async def compare_two_cities(
    ...
    '''http://127.0.0.1:8000/cities/compare/{first_city}&{second_city}'''
...
async def find_available_cities(
    ...
    '''http://127.0.0.1:8000/cities/find/{hint}'''
